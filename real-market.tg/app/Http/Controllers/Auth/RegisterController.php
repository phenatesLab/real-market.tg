    ...
    */
    ...
    public function confirm(int $id, string $token)
    {
        ...
        if ($user) {
            ...
            return redirect('/property')->withSuccess('Votre compte a bien été confirmé');
        }
        else {
    ...
    public function register(Request $request)
    {
        ...
        return redirect('/login')->withSuccess("Votre compte a bien été créé, vous de le confirmer avec
         l'email que vous allez rercevoir");
    }
